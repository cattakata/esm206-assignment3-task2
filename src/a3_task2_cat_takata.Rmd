...
author: "Cat Takata - ESM 206 Fall 2020"
...
#### Since Row 49 had multiple dashes, R automatically sepearted it at the first dash, based off what we told it. It didn't register the 2nd dash, making it drop the rest of the name. 
...
shots_by_month <- gasol_hookshots %>% 
  count(month)
